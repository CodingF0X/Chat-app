...
export type ChatFragmentFragment = { __typename?: 'Chat', _id: string, name: string, latestMessage: { __typename?: 'Message', _id: string, content: string, chatId: string, createdAt: string, user: { __typename?: 'User', _id: string, email: string } } };
...
export type Create_New_ChatMutation = { __typename?: 'Mutation', Create_New_Chat: { __typename?: 'Chat', _id: string, name: string, latestMessage: { __typename?: 'Message', _id: string, content: string, chatId: string, createdAt: string, user: { __typename?: 'User', _id: string, email: string } } } };
...
export type GetChatQuery = { __typename?: 'Query', Find_Single_Chat: { __typename?: 'Chat', _id: string, name: string, latestMessage: { __typename?: 'Message', _id: string, content: string, chatId: string, createdAt: string, user: { __typename?: 'User', _id: string, email: string } } } };

export type GetChatsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetChatsQuery = { __typename?: 'Query', Find_Chats: Array<{ __typename?: 'Chat', _id: string, name: string, latestMessage: { __typename?: 'Message', _id: string, content: string, chatId: string, createdAt: string, user: { __typename?: 'User', _id: string, email: string } } }> };
