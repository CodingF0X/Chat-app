...
export type MessageFragmentFragment = { __typename?: 'Message', _id: string, content: string, sender: string, chatId: string, createdAt: string };
...
export type GetMessagesQuery = { __typename?: 'Query', Get_All_Messages: Array<{ __typename?: 'Message', _id: string, content: string, sender: string, chatId: string, createdAt: string }> };
...
export type MessageCreatedSubscription = { __typename?: 'Subscription', Message_Created: { __typename?: 'Message', _id: string, content: string, sender: string, chatId: string, createdAt: string } };
...
export type CreateMessageMutation = { __typename?: 'Mutation', Create_New_Message: { __typename?: 'Message', _id: string, content: string, sender: string, chatId: string, createdAt: string } };
